...
- `mtl::not_unique_exclusive` [(Documentation)](../mtl/algorithm.hpp#L40) [(Examples)](../tests/tests_algorithm.cpp#L240)
- `mtl::not_unique` [(Documentation)](../mtl/algorithm.hpp#L42) [(Examples)](../tests/tests_algorithm.cpp#L437)
- `mtl::keep_duplicates_inclusive` [(Documentation)](../mtl/algorithm.hpp#L482) [(Examples)](../tests/tests_algorithm.cpp#L629)
- `mtl::keep_duplicates_exclusive` [(Documentation)](../mtl/algorithm.hpp#L630) [(Examples)](../tests/tests_algorithm.cpp#L796)
- `mtl::keep_duplicates` [(Documentation)](../mtl/algorithm.hpp#L760) [(Examples)](../tests/tests_algorithm.cpp#L955)
- `mtl::keep_duplicates_inclusive_sorted` [(Documentation)](../mtl/algorithm.hpp#L480) [(Examples)](../tests/tests_algorithm.cpp#L1119)
- `mtl::keep_duplicates_exclusive_sorted` [(Documentation)](../mtl/algorithm.hpp#L628) [(Examples)](../tests/tests_algorithm.cpp#L1309)
- `mtl::keep_duplicates_sorted` [(Documentation)](../mtl/algorithm.hpp#L758) [(Examples)](../tests/tests_algorithm.cpp#L1494)
- `mtl::keep_duplicates_inclusive_preserve` [(Documentation)](../mtl/algorithm.hpp#L484) [(Examples)](../tests/tests_algorithm.cpp#L1686)
- `mtl::keep_duplicates_exclusive_preserve` [(Documentation)](../mtl/algorithm.hpp#L632) [(Examples)](../tests/tests_algorithm.cpp#L1851)
- `mtl::keep_duplicates_preserve` [(Documentation)](../mtl/algorithm.hpp#L761) [(Examples)](../tests/tests_algorithm.cpp#L2018)
- `mtl::rem_duplicates_sorted` [(Documentation)](../mtl/algorithm.hpp#L279) [(Examples)](../tests/tests_algorithm.cpp#L2180)
- `mtl::rem_duplicates` [(Documentation)](../mtl/algorithm.hpp#L280) [(Examples)](../tests/tests_algorithm.cpp#L2369)
- `mtl::rem_duplicates_preserve` [(Documentation)](../mtl/algorithm.hpp#L281) [(Examples)](../tests/tests_algorithm.cpp#L2523)
- `mtl::contains` [(Documentation)](../mtl/algorithm.hpp#L874) [(Examples)](../tests/tests_algorithm.cpp#L2686)
- `mtl::contains_all` [(Documentation)](../mtl/algorithm.hpp#L927) [(Examples)](../tests/tests_algorithm.cpp#L2834)
- `mtl::contains_all_sorted` [(Documentation)](../mtl/algorithm.hpp#L928) [(Examples)](../tests/tests_algorithm.cpp#L2995)
- `mtl::for_each` [(Documentation)](../mtl/algorithm.hpp#L1010) [(Examples)](../tests/tests_algorithm.cpp#L3156)
- `mtl::for_adj_pairs` [(Documentation)](../mtl/algorithm.hpp#L1155) [(Examples)](../tests/tests_algorithm.cpp#L3651)
- `mtl::for_all_pairs` [(Documentation)](../mtl/algorithm.hpp#L1184) [(Examples)](../tests/tests_algorithm.cpp#L3739)
- `mtl::fill_range` [(Documentation)](../mtl/algorithm.hpp#L1220) [(Examples)](../tests/tests_algorithm.cpp#L3831)
- `mtl::range` [(Documentation)](../mtl/algorithm.hpp#L1263) [(Examples)](../tests/tests_algorithm.cpp#L3953)
...
- [**CLASS**] `mtl::xoroshiro128plus_engine` [(Documentation)](../mtl/xoroshiro128plus.hpp#L31) [(Examples)](../tests/tests_xoroshiro128plus.cpp#L29)
  ...
  - `mtl::xoroshiro128plus_engine::seed` [(Documentation)](../mtl/xoroshiro128plus.hpp#L233) [(Examples)](../tests/tests_xoroshiro128plus.cpp#L35)
  - `mtl::xoroshiro128plus_engine::min` [(Documentation)](../mtl/xoroshiro128plus.hpp#L274) [(Examples)](../tests/tests_xoroshiro128plus.cpp#L37)
  - `mtl::xoroshiro128plus_engine::max` [(Documentation)](../mtl/xoroshiro128plus.hpp#L283) [(Examples)](../tests/tests_xoroshiro128plus.cpp#L39)
  - `mtl::xoroshiro128plus_engine::operator()` [(Documentation)](../mtl/xoroshiro128plus.hpp#L292) [(Examples)](../tests/tests_xoroshiro128plus.cpp#L41)
  - `mtl::xoroshiro128plus_engine::generate` [(Documentation)](../mtl/xoroshiro128plus.hpp#L310) [(Examples)](../tests/tests_xoroshiro128plus.cpp#L43)
  - `mtl::xoroshiro128plus_engine::discard` [(Documentation)](../mtl/xoroshiro128plus.hpp#L327) [(Examples)](../tests/tests_xoroshiro128plus.cpp#L45)
  - `mtl::xoroshiro128plus_engine::operator<<` [(Documentation)](../mtl/xoroshiro128plus.hpp#L341) [(Examples)](../tests/tests_xoroshiro128plus.cpp#L47)
  - `mtl::xoroshiro128plus_engine::operator>>` [(Documentation)](../mtl/xoroshiro128plus.hpp#L358) [(Examples)](../tests/tests_xoroshiro128plus.cpp#L49)
  - `mtl::xoroshiro128plus_engine::operator==` [(Documentation)](../mtl/xoroshiro128plus.hpp#L377) [(Examples)](../tests/tests_xoroshiro128plus.cpp#L51)
  - `mtl::xoroshiro128plus_engine::operator!=` [(Documentation)](../mtl/xoroshiro128plus.hpp#L390) [(Examples)](../tests/tests_xoroshiro128plus.cpp#L53)
- [**CLASS**] `mtl::xoroshiro128plus` [(Documentation)](../mtl/xoroshiro128plus.hpp#L405) [(Examples)](../tests/tests_xoroshiro128plus.cpp#L55)
...
- [**CLASS**] `mtl::xorshift128plus_engine` [(Documentation)](../mtl/xorshift128plus.hpp#L31) [(Examples)](../tests/tests_xorshift128plus.cpp#L31)
  ...
  - `mtl::xorshift128plus_engine::seed` [(Documentation)](../mtl/xorshift128plus.hpp#L236) [(Examples)](../tests/tests_xorshift128plus.cpp#L37)
  - `mtl::xorshift128plus_engine::min` [(Documentation)](../mtl/xorshift128plus.hpp#L277) [(Examples)](../tests/tests_xorshift128plus.cpp#L39)
  - `mtl::xorshift128plus_engine::max` [(Documentation)](../mtl/xorshift128plus.hpp#L286) [(Examples)](../tests/tests_xorshift128plus.cpp#L41)
  - `mtl::xorshift128plus_engine::operator()` [(Documentation)](../mtl/xorshift128plus.hpp#L295) [(Examples)](../tests/tests_xorshift128plus.cpp#L43)
  - `mtl::xorshift128plus_engine::generate` [(Documentation)](../mtl/xorshift128plus.hpp#L315) [(Examples)](../tests/tests_xorshift128plus.cpp#L45)
  - `mtl::xorshift128plus_engine::discard` [(Documentation)](../mtl/xorshift128plus.hpp#L332) [(Examples)](../tests/tests_xorshift128plus.cpp#L47)
  - `mtl::xorshift128plus_engine::operator<<` [(Documentation)](../mtl/xorshift128plus.hpp#L346) [(Examples)](../tests/tests_xorshift128plus.cpp#L49)
  - `mtl::xorshift128plus_engine::operator>>` [(Documentation)](../mtl/xorshift128plus.hpp#L363) [(Examples)](../tests/tests_xorshift128plus.cpp#L51)
  - `mtl::xorshift128plus_engine::operator==` [(Documentation)](../mtl/xorshift128plus.hpp#L382) [(Examples)](../tests/tests_xorshift128plus.cpp#L53)
  - `mtl::xorshift128plus_engine::operator!=` [(Documentation)](../mtl/xorshift128plus.hpp#L395) [(Examples)](../tests/tests_xorshift128plus.cpp#L55)
- [**CLASS**] `mtl::xorshift128plus` [(Documentation)](../mtl/xorshift128plus.hpp#L409) [(Examples)](../tests/tests_xorshift128plus.cpp#L57)
...
- [**CLASS**] `mtl::xoshiro256plus_engine` [(Documentation)](../mtl/xoshiro256plus.hpp#L31) [(Examples)](../tests/tests_xoshiro256plus.cpp#L31)
  ...
  - `mtl::xoshiro256plus_engine::seed` [(Documentation)](../mtl/xoshiro256plus.hpp#L272) [(Examples)](../tests/tests_xoshiro256plus.cpp#L37)
  - `mtl::xoshiro256plus_engine::min` [(Documentation)](../mtl/xoshiro256plus.hpp#L330) [(Examples)](../tests/tests_xoshiro256plus.cpp#L39)
  - `mtl::xoshiro256plus_engine::max` [(Documentation)](../mtl/xoshiro256plus.hpp#L339) [(Examples)](../tests/tests_xoshiro256plus.cpp#L41)
  - `mtl::xoshiro256plus_engine::operator()` [(Documentation)](../mtl/xoshiro256plus.hpp#L348) [(Examples)](../tests/tests_xoshiro256plus.cpp#L43)
  - `mtl::xoshiro256plus_engine::generate` [(Documentation)](../mtl/xoshiro256plus.hpp#L369) [(Examples)](../tests/tests_xoshiro256plus.cpp#L45)
  - `mtl::xoshiro256plus_engine::discard` [(Documentation)](../mtl/xoshiro256plus.hpp#L386) [(Examples)](../tests/tests_xoshiro256plus.cpp#L47)
  - `mtl::xoshiro256plus_engine::operator<<` [(Documentation)](../mtl/xoshiro256plus.hpp#L400) [(Examples)](../tests/tests_xoshiro256plus.cpp#L49)
  - `mtl::xoshiro256plus_engine::operator>>` [(Documentation)](../mtl/xoshiro256plus.hpp#L418) [(Examples)](../tests/tests_xoshiro256plus.cpp#L51)
  - `mtl::xoshiro256plus_engine::operator==` [(Documentation)](../mtl/xoshiro256plus.hpp#L439) [(Examples)](../tests/tests_xoshiro256plus.cpp#L53)
  - `mtl::xoshiro256plus_engine::operator!=` [(Documentation)](../mtl/xoshiro256plus.hpp#L452) [(Examples)](../tests/tests_xoshiro256plus.cpp#L55)
- [**CLASS**] `mtl::xoshiro256plus` [(Documentation)](../mtl/xoshiro256plus.hpp#L466) [(Examples)](../tests/tests_xoshiro256plus.cpp#L57)
