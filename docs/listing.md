...
- `mtl::keep_duplicates_exclusive` [(Documentation)](../mtl/algorithm.hpp#L631) [(Examples)](../tests/tests_algorithm.cpp#L1066)
- `mtl::keep_duplicates` [(Documentation)](../mtl/algorithm.hpp#L761) [(Examples)](../tests/tests_algorithm.cpp#L1225)
- `mtl::keep_duplicates_inclusive_sorted` [(Documentation)](../mtl/algorithm.hpp#L477) [(Examples)](../tests/tests_algorithm.cpp#L1389)
- `mtl::keep_duplicates_exclusive_sorted` [(Documentation)](../mtl/algorithm.hpp#L629) [(Examples)](../tests/tests_algorithm.cpp#L1579)
- `mtl::keep_duplicates_sorted` [(Documentation)](../mtl/algorithm.hpp#L759) [(Examples)](../tests/tests_algorithm.cpp#L1764)
- `mtl::keep_duplicates_inclusive_preserve` [(Documentation)](../mtl/algorithm.hpp#L481) [(Examples)](../tests/tests_algorithm.cpp#L1956)
- `mtl::keep_duplicates_exclusive_preserve` [(Documentation)](../mtl/algorithm.hpp#L633) [(Examples)](../tests/tests_algorithm.cpp#L2121)
- `mtl::keep_duplicates_preserve` [(Documentation)](../mtl/algorithm.hpp#L762) [(Examples)](../tests/tests_algorithm.cpp#L2288)
...
- `mtl::contains` [(Documentation)](../mtl/algorithm.hpp#L875) [(Examples)](../tests/tests_algorithm.cpp#L2956)
- `mtl::contains_all` [(Documentation)](../mtl/algorithm.hpp#L928) [(Examples)](../tests/tests_algorithm.cpp#L3104)
- `mtl::contains_all_sorted` [(Documentation)](../mtl/algorithm.hpp#L929) [(Examples)](../tests/tests_algorithm.cpp#L3265)
- `mtl::for_each` [(Documentation)](../mtl/algorithm.hpp#L1011) [(Examples)](../tests/tests_algorithm.cpp#L3426)
- `mtl::for_adj_pairs` [(Documentation)](../mtl/algorithm.hpp#L1156) [(Examples)](../tests/tests_algorithm.cpp#L3921)
- `mtl::for_all_pairs` [(Documentation)](../mtl/algorithm.hpp#L1185) [(Examples)](../tests/tests_algorithm.cpp#L4009)
- `mtl::fill_range` [(Documentation)](../mtl/algorithm.hpp#L1221) [(Examples)](../tests/tests_algorithm.cpp#L4101)
- `mtl::range` [(Documentation)](../mtl/algorithm.hpp#L1264) [(Examples)](../tests/tests_algorithm.cpp#L4223)
