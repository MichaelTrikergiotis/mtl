...
- `mtl::string::to_upper` [(Documentation)](../mtl/string.hpp#L109) [(Examples)](../tests/tests_string.cpp#L153)
- `mtl::string::to_lower` [(Documentation)](../mtl/string.hpp#L111) [(Examples)](../tests/tests_string.cpp#L153)
- `mtl::string::is_ascii` [(Documentation)](../mtl/string.hpp#L160) [(Examples)](../tests/tests_string.cpp#L241)
- `mtl::string::is_alphabetic` [(Documentation)](../mtl/string.hpp#L209) [(Examples)](../tests/tests_string.cpp#L289)
- `mtl::string::is_numeric` [(Documentation)](../mtl/string.hpp#L211) [(Examples)](../tests/tests_string.cpp#L289)
- `mtl::string::is_alphanum` [(Documentation)](../mtl/string.hpp#L212) [(Examples)](../tests/tests_string.cpp#L289)
- `mtl::string::contains` [(Documentation)](../mtl/string.hpp#L310) [(Examples)](../tests/tests_string.cpp#L396)
- `mtl::string::strip_front` [(Documentation)](../mtl/string.hpp#L380) [(Examples)](../tests/tests_string.cpp#L472)
- `mtl::string::strip_back` [(Documentation)](../mtl/string.hpp#L381) [(Examples)](../tests/tests_string.cpp#L472)
- `mtl::string::strip` [(Documentation)](../mtl/string.hpp#L382) [(Examples)](../tests/tests_string.cpp#L472)
- `mtl::string::pad_front` [(Documentation)](../mtl/string.hpp#L455) [(Examples)](../tests/tests_string.cpp#L706)
- `mtl::string::pad_back` [(Documentation)](../mtl/string.hpp#L458) [(Examples)](../tests/tests_string.cpp#L706)
- `mtl::string::pad` [(Documentation)](../mtl/string.hpp#L461) [(Examples)](../tests/tests_string.cpp#L706)
- `mtl::string::to_string` [(Documentation)](../mtl/string.hpp#L621) [(Examples)](../tests/tests_string.cpp#L924)
- `mtl::string::join_all` [(Documentation)](../mtl/string.hpp#L737) [(Examples)](../tests/tests_string.cpp#L1017)
- `mtl::string::join` [(Documentation)](../mtl/string.hpp#L913) [(Examples)](../tests/tests_string.cpp#L1240)
- `mtl::string::split` [(Documentation)](../mtl/string.hpp#L1050) [(Examples)](../tests/tests_string.cpp#L1286)
- `mtl::string::replace` [(Documentation)](../mtl/string.hpp#L1188) [(Examples)](../tests/tests_string.cpp#L2394)
- `mtl::string::replace_all` [(Documentation)](../mtl/string.hpp#L1496) [(Examples)](../tests/tests_string.cpp#L3052)
