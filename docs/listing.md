...
- `mtl::not_unique_inclusive` [(Documentation)](../mtl/algorithm.hpp#L35) [(Examples)](../tests/tests_algorithm.cpp#L41)
- `mtl::not_unique_exclusive` [(Documentation)](../mtl/algorithm.hpp#L37) [(Examples)](../tests/tests_algorithm.cpp#L226)
- `mtl::not_unique` [(Documentation)](../mtl/algorithm.hpp#L39) [(Examples)](../tests/tests_algorithm.cpp#L408)
- `mtl::keep_duplicates_inclusive` [(Documentation)](../mtl/algorithm.hpp#L457) [(Examples)](../tests/tests_algorithm.cpp#L585)
- `mtl::keep_duplicates_exclusive` [(Documentation)](../mtl/algorithm.hpp#L605) [(Examples)](../tests/tests_algorithm.cpp#L752)
- `mtl::keep_duplicates` [(Documentation)](../mtl/algorithm.hpp#L735) [(Examples)](../tests/tests_algorithm.cpp#L911)
- `mtl::keep_duplicates_inclusive_sorted` [(Documentation)](../mtl/algorithm.hpp#L455) [(Examples)](../tests/tests_algorithm.cpp#L1075)
- `mtl::keep_duplicates_exclusive_sorted` [(Documentation)](../mtl/algorithm.hpp#L603) [(Examples)](../tests/tests_algorithm.cpp#L1265)
- `mtl::keep_duplicates_sorted` [(Documentation)](../mtl/algorithm.hpp#L733) [(Examples)](../tests/tests_algorithm.cpp#L1450)
- `mtl::keep_duplicates_inclusive_preserve` [(Documentation)](../mtl/algorithm.hpp#L459) [(Examples)](../tests/tests_algorithm.cpp#L1642)
- `mtl::keep_duplicates_exclusive_preserve` [(Documentation)](../mtl/algorithm.hpp#L607) [(Examples)](../tests/tests_algorithm.cpp#L1807)
- `mtl::keep_duplicates_preserve` [(Documentation)](../mtl/algorithm.hpp#L736) [(Examples)](../tests/tests_algorithm.cpp#L1974)
- `mtl::rem_duplicates_sorted` [(Documentation)](../mtl/algorithm.hpp#L254) [(Examples)](../tests/tests_algorithm.cpp#L2136)
- `mtl::rem_duplicates` [(Documentation)](../mtl/algorithm.hpp#L255) [(Examples)](../tests/tests_algorithm.cpp#L2325)
- `mtl::rem_duplicates_preserve` [(Documentation)](../mtl/algorithm.hpp#L256) [(Examples)](../tests/tests_algorithm.cpp#L2479)
- `mtl::contains` [(Documentation)](../mtl/algorithm.hpp#L849) [(Examples)](../tests/tests_algorithm.cpp#L2642)
- `mtl::contains_all` [(Documentation)](../mtl/algorithm.hpp#L902) [(Examples)](../tests/tests_algorithm.cpp#L2790)
- `mtl::contains_all_sorted` [(Documentation)](../mtl/algorithm.hpp#L903) [(Examples)](../tests/tests_algorithm.cpp#L2951)
- `mtl::for_each` [(Documentation)](../mtl/algorithm.hpp#L985) [(Examples)](../tests/tests_algorithm.cpp#L3112)
- `mtl::for_adj_pairs` [(Documentation)](../mtl/algorithm.hpp#L1130) [(Examples)](../tests/tests_algorithm.cpp#L3607)
- `mtl::for_all_pairs` [(Documentation)](../mtl/algorithm.hpp#L1159) [(Examples)](../tests/tests_algorithm.cpp#L3695)
- `mtl::fill_range` [(Documentation)](../mtl/algorithm.hpp#L1195) [(Examples)](../tests/tests_algorithm.cpp#L3787)
- `mtl::range` [(Documentation)](../mtl/algorithm.hpp#L1238) [(Examples)](../tests/tests_algorithm.cpp#L3909)
...
- `mtl::string::is_lower` [(Documentation)](../mtl/string.hpp#L42) [(Examples)](../tests/tests_string.cpp#L202)
- `mtl::string::to_upper` [(Documentation)](../mtl/string.hpp#L109) [(Examples)](../tests/tests_string.cpp#L317)
- `mtl::string::to_lower` [(Documentation)](../mtl/string.hpp#L111) [(Examples)](../tests/tests_string.cpp#L317)
- `mtl::string::is_ascii` [(Documentation)](../mtl/string.hpp#L160) [(Examples)](../tests/tests_string.cpp#L405)
- `mtl::string::is_alphabetic` [(Documentation)](../mtl/string.hpp#L209) [(Examples)](../tests/tests_string.cpp#L453)
- `mtl::string::is_numeric` [(Documentation)](../mtl/string.hpp#L211) [(Examples)](../tests/tests_string.cpp#L587)
- `mtl::string::is_alphanum` [(Documentation)](../mtl/string.hpp#L212) [(Examples)](../tests/tests_string.cpp#L721)
- `mtl::string::contains` [(Documentation)](../mtl/string.hpp#L310) [(Examples)](../tests/tests_string.cpp#L853)
- `mtl::string::strip_front` [(Documentation)](../mtl/string.hpp#L380) [(Examples)](../tests/tests_string.cpp#L929)
- `mtl::string::strip_back` [(Documentation)](../mtl/string.hpp#L381) [(Examples)](../tests/tests_string.cpp#L929)
- `mtl::string::strip` [(Documentation)](../mtl/string.hpp#L382) [(Examples)](../tests/tests_string.cpp#L929)
- `mtl::string::pad_front` [(Documentation)](../mtl/string.hpp#L455) [(Examples)](../tests/tests_string.cpp#L1163)
- `mtl::string::pad_back` [(Documentation)](../mtl/string.hpp#L458) [(Examples)](../tests/tests_string.cpp#L1163)
- `mtl::string::pad` [(Documentation)](../mtl/string.hpp#L461) [(Examples)](../tests/tests_string.cpp#L1163)
- `mtl::string::to_string` [(Documentation)](../mtl/string.hpp#L621) [(Examples)](../tests/tests_string.cpp#L1381)
- `mtl::string::join_all` [(Documentation)](../mtl/string.hpp#L737) [(Examples)](../tests/tests_string.cpp#L1474)
- `mtl::string::join` [(Documentation)](../mtl/string.hpp#L913) [(Examples)](../tests/tests_string.cpp#L1697)
- `mtl::string::split` [(Documentation)](../mtl/string.hpp#L1050) [(Examples)](../tests/tests_string.cpp#L1743)
- `mtl::string::replace` [(Documentation)](../mtl/string.hpp#L1188) [(Examples)](../tests/tests_string.cpp#L2851)
- `mtl::string::replace_all` [(Documentation)](../mtl/string.hpp#L1496) [(Examples)](../tests/tests_string.cpp#L3509)
