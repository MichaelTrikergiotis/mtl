...
- `mtl::not_unique_exclusive` [(Documentation)](../mtl/algorithm.hpp#L37) [(Examples)](../tests/tests_algorithm.cpp#L40)
- `mtl::not_unique` [(Documentation)](../mtl/algorithm.hpp#L39) [(Examples)](../tests/tests_algorithm.cpp#L40)
- `mtl::keep_duplicates_inclusive` [(Documentation)](../mtl/algorithm.hpp#L457) [(Examples)](../tests/tests_algorithm.cpp#L327)
- `mtl::keep_duplicates_exclusive` [(Documentation)](../mtl/algorithm.hpp#L605) [(Examples)](../tests/tests_algorithm.cpp#L327)
- `mtl::keep_duplicates` [(Documentation)](../mtl/algorithm.hpp#L735) [(Examples)](../tests/tests_algorithm.cpp#L327)
- `mtl::keep_duplicates_inclusive_sorted` [(Documentation)](../mtl/algorithm.hpp#L455) [(Examples)](../tests/tests_algorithm.cpp#L523)
- `mtl::keep_duplicates_exclusive_sorted` [(Documentation)](../mtl/algorithm.hpp#L603) [(Examples)](../tests/tests_algorithm.cpp#L564)
- `mtl::keep_duplicates_sorted` [(Documentation)](../mtl/algorithm.hpp#L733) [(Examples)](../tests/tests_algorithm.cpp#L606)
- `mtl::keep_duplicates_inclusive_preserve` [(Documentation)](../mtl/algorithm.hpp#L459) [(Examples)](../tests/tests_algorithm.cpp#L756)
- `mtl::keep_duplicates_exclusive_preserve` [(Documentation)](../mtl/algorithm.hpp#L607) [(Examples)](../tests/tests_algorithm.cpp#L809)
- `mtl::keep_duplicates_preserve` [(Documentation)](../mtl/algorithm.hpp#L736) [(Examples)](../tests/tests_algorithm.cpp#L845)
- `mtl::rem_duplicates_sorted` [(Documentation)](../mtl/algorithm.hpp#L254) [(Examples)](../tests/tests_algorithm.cpp#L971)
- `mtl::rem_duplicates` [(Documentation)](../mtl/algorithm.hpp#L255) [(Examples)](../tests/tests_algorithm.cpp#L971)
- `mtl::rem_duplicates_preserve` [(Documentation)](../mtl/algorithm.hpp#L256) [(Examples)](../tests/tests_algorithm.cpp#L971)
- `mtl::contains` [(Documentation)](../mtl/algorithm.hpp#L848) [(Examples)](../tests/tests_algorithm.cpp#L1223)
- `mtl::contains_all` [(Documentation)](../mtl/algorithm.hpp#L901) [(Examples)](../tests/tests_algorithm.cpp#L1223)
- `mtl::contains_all_sorted` [(Documentation)](../mtl/algorithm.hpp#L902) [(Examples)](../tests/tests_algorithm.cpp#L1223)
- `mtl::fill_range` [(Documentation)](../mtl/algorithm.hpp#L983) [(Examples)](../tests/tests_algorithm.cpp#L1698)
- `mtl::for_each` [(Documentation)](../mtl/algorithm.hpp#L1025) [(Examples)](../tests/tests_algorithm.cpp#L1818)
- `mtl::for_adj_pairs` [(Documentation)](../mtl/algorithm.hpp#L1110) [(Examples)](../tests/tests_algorithm.cpp#L1881)
- `mtl::for_all_pairs` [(Documentation)](../mtl/algorithm.hpp#L1139) [(Examples)](../tests/tests_algorithm.cpp#L1881)
- `mtl::range` [(Documentation)](../mtl/algorithm.hpp#L1175) [(Examples)](../tests/tests_algorithm.cpp#L2060)

---------------------------------------------------

## console.hpp

- `mtl::console::print` [(Documentation)](../mtl/console.hpp#L156) [(Examples)](../tests/tests_console.cpp#L71)
- `mtl::console::println` [(Documentation)](../mtl/console.hpp#L185) [(Examples)](../tests/tests_console.cpp#L71)
- `mtl::console::print_all` [(Documentation)](../mtl/console.hpp#L219) [(Examples)](../tests/tests_console.cpp#L338)
- `mtl::console::print_color` [(Documentation)](../mtl/console.hpp#L471) [(Examples)](../tests/tests_console.cpp#L605)
- `mtl::console::println_color` [(Documentation)](../mtl/console.hpp#L472) [(Examples)](../tests/tests_console.cpp#L854)
- `mtl::console::overtype` [(Documentation)](../mtl/console.hpp#L1158) [(Examples)](../tests/tests_console.cpp#L1016)
- `mtl::console::clear` [(Documentation)](../mtl/console.hpp#L1216) [(Examples)](../tests/tests_console.cpp#L1396)
...
- `mtl::to_num` [(Documentation)](../mtl/conversion.hpp#L25) [(Examples)](../tests/tests_conversion.cpp#L66)
- `mtl::to_num_noex` [(Documentation)](../mtl/conversion.hpp#L26) [(Examples)](../tests/tests_conversion.cpp#L481)
- `mtl::numeric_cast` [(Documentation)](../mtl/conversion.hpp#L708) [(Examples)](../tests/tests_conversion.cpp#L1511)
- `mtl::numeric_cast_noex` [(Documentation)](../mtl/conversion.hpp#L710) [(Examples)](../tests/tests_conversion.cpp#L2129)
- `mtl::rounding_cast` [(Documentation)](../mtl/conversion.hpp#L790) [(Examples)](../tests/tests_conversion.cpp#L4788)
- `mtl::rounding_cast_noex` [(Documentation)](../mtl/conversion.hpp#L791) [(Examples)](../tests/tests_conversion.cpp#L4881)
...
- `mtl::string::pad_front` [(Documentation)](../mtl/string.hpp#L468) [(Examples)](../tests/tests_string.cpp#L632)
- `mtl::string::pad_back` [(Documentation)](../mtl/string.hpp#L471) [(Examples)](../tests/tests_string.cpp#L632)
- `mtl::string::pad` [(Documentation)](../mtl/string.hpp#L474) [(Examples)](../tests/tests_string.cpp#L632)
- `mtl::string::to_string` [(Documentation)](../mtl/string.hpp#L632) [(Examples)](../tests/tests_string.cpp#L850)
- `mtl::string::join_all` [(Documentation)](../mtl/string.hpp#L749) [(Examples)](../tests/tests_string.cpp#L943)
- `mtl::string::join` [(Documentation)](../mtl/string.hpp#L926) [(Examples)](../tests/tests_string.cpp#L943)
- `mtl::string::split` [(Documentation)](../mtl/string.hpp#L1064) [(Examples)](../tests/tests_string.cpp#L1141)
- `mtl::string::replace` [(Documentation)](../mtl/string.hpp#L1193) [(Examples)](../tests/tests_string.cpp#L1685)
- `mtl::string::replace_all` [(Documentation)](../mtl/string.hpp#L1501) [(Examples)](../tests/tests_string.cpp#L2343)
...
- [**CLASS**] `mtl::xoroshiro128plus_engine` [(Documentation)](../mtl/xoroshiro128plus.hpp#L27) [(Examples)](../tests/tests_xoroshiro128plus.cpp#L30)
  ...
  - `mtl::xoroshiro128plus_engine::generate` [(Documentation)](../mtl/xoroshiro128plus.hpp#L299) [(Examples)](../tests/tests_xoroshiro128plus.cpp#L44)
  - `mtl::xoroshiro128plus_engine::discard` [(Documentation)](../mtl/xoroshiro128plus.hpp#L316) [(Examples)](../tests/tests_xoroshiro128plus.cpp#L46)
  - `mtl::xoroshiro128plus_engine::operator<<` [(Documentation)](../mtl/xoroshiro128plus.hpp#L330) [(Examples)](../tests/tests_xoroshiro128plus.cpp#L48)
  - `mtl::xoroshiro128plus_engine::operator>>` [(Documentation)](../mtl/xoroshiro128plus.hpp#L347) [(Examples)](../tests/tests_xoroshiro128plus.cpp#L50)
  - `mtl::xoroshiro128plus_engine::operator==` [(Documentation)](../mtl/xoroshiro128plus.hpp#L366) [(Examples)](../tests/tests_xoroshiro128plus.cpp#L52)
  - `mtl::xoroshiro128plus_engine::operator!=` [(Documentation)](../mtl/xoroshiro128plus.hpp#L379) [(Examples)](../tests/tests_xoroshiro128plus.cpp#L54)
- [**CLASS**] `mtl::xoroshiro128plus` [(Documentation)](../mtl/xoroshiro128plus.hpp#L394) [(Examples)](../tests/tests_xoroshiro128plus.cpp#L56)
...
- [**CLASS**] `mtl::xorshift128plus_engine` [(Documentation)](../mtl/xorshift128plus.hpp#L27) [(Examples)](../tests/tests_xorshift128plus.cpp#L32)
  ...
  - `mtl::xorshift128plus_engine::generate` [(Documentation)](../mtl/xorshift128plus.hpp#L304) [(Examples)](../tests/tests_xorshift128plus.cpp#L46)
  - `mtl::xorshift128plus_engine::discard` [(Documentation)](../mtl/xorshift128plus.hpp#L321) [(Examples)](../tests/tests_xorshift128plus.cpp#L48)
  - `mtl::xorshift128plus_engine::operator<<` [(Documentation)](../mtl/xorshift128plus.hpp#L335) [(Examples)](../tests/tests_xorshift128plus.cpp#L50)
  - `mtl::xorshift128plus_engine::operator>>` [(Documentation)](../mtl/xorshift128plus.hpp#L352) [(Examples)](../tests/tests_xorshift128plus.cpp#L52)
  - `mtl::xorshift128plus_engine::operator==` [(Documentation)](../mtl/xorshift128plus.hpp#L371) [(Examples)](../tests/tests_xorshift128plus.cpp#L54)
  - `mtl::xorshift128plus_engine::operator!=` [(Documentation)](../mtl/xorshift128plus.hpp#L384) [(Examples)](../tests/tests_xorshift128plus.cpp#L56)
- [**CLASS**] `mtl::xorshift128plus` [(Documentation)](../mtl/xorshift128plus.hpp#L398) [(Examples)](../tests/tests_xorshift128plus.cpp#L58)
...
- [**CLASS**] `mtl::xoshiro256plus_engine` [(Documentation)](../mtl/xoshiro256plus.hpp#L27) [(Examples)](../tests/tests_xoshiro256plus.cpp#L32)
  ...
  - `mtl::xoshiro256plus_engine::generate` [(Documentation)](../mtl/xoshiro256plus.hpp#L358) [(Examples)](../tests/tests_xoshiro256plus.cpp#L46)
  - `mtl::xoshiro256plus_engine::discard` [(Documentation)](../mtl/xoshiro256plus.hpp#L375) [(Examples)](../tests/tests_xoshiro256plus.cpp#L48)
  - `mtl::xoshiro256plus_engine::operator<<` [(Documentation)](../mtl/xoshiro256plus.hpp#L389) [(Examples)](../tests/tests_xoshiro256plus.cpp#L50)
  - `mtl::xoshiro256plus_engine::operator>>` [(Documentation)](../mtl/xoshiro256plus.hpp#L407) [(Examples)](../tests/tests_xoshiro256plus.cpp#L52)
  - `mtl::xoshiro256plus_engine::operator==` [(Documentation)](../mtl/xoshiro256plus.hpp#L428) [(Examples)](../tests/tests_xoshiro256plus.cpp#L54)
  - `mtl::xoshiro256plus_engine::operator!=` [(Documentation)](../mtl/xoshiro256plus.hpp#L441) [(Examples)](../tests/tests_xoshiro256plus.cpp#L56)
- [**CLASS**] `mtl::xoshiro256plus` [(Documentation)](../mtl/xoshiro256plus.hpp#L455) [(Examples)](../tests/tests_xoshiro256plus.cpp#L58)
