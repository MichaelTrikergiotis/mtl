...
echo.
echo [Compiling CMake - MSVC - debug build]
...
echo.
echo [Compiling CMake - clang-cl - debug build]
...
echo.
echo [Compiling CMake - MSVC - release build]
...
echo.
echo [Compiling CMake - clang-cl - release build]
