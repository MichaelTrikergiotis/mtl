#pragma once
// xorshift128plus random number generator by Michael Trikergiotis
// 28/09/2018
// 
// Header that implements the xorshift128plus random number generator in the way that the C++ 
...
/// This is the engine for the xorshift128plus random number generator. For general purpose 
/// everyday use you should use the xorshift128plus typedef instead of this. This template allows
...
public:
	...
	// ============================================================================================
	// XORSHIFT128PLUS_ENGINE - Copy constructor that copies the state of another random engine of
	//                          the same type.
	// ============================================================================================
